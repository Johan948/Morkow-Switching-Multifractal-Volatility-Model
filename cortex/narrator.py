...
using OpenAI's API. This is NOT a template engine — every response is
generated by an LLM call with full context injection.
...
def _get_client():
    """Lazy-initialize async OpenAI client on first use."""
    global _client
